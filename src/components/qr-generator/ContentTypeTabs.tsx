...
import { Link, FileText, Mail, MessageSquare, Wifi, Youtube } from 'lucide-react';
...
export const ContentTypeTabs: React.FC<ContentTypeTabsProps> = ({
  ...
  return (
    <Tabs defaultValue="url" className="w-full" onValueChange={handleContentTypeChange}>
      ...
      <TabsContent value="youtube" className="mt-4"><YoutubeForm onValueChange={setQrValue} /></TabsContent>
    </Tabs>
  );
};